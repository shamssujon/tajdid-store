...
const ProductCard = (product) => {
	...
	return (
		<>
				...
				<div className="p-6">
					<div className="flex items-start justify-between gap-4">
						...
						<button
							...
							className="inline-grid place-content-center rounded-md border p-2 text-rose-600">
			...
			{openDialog && <DeleteConfirmationDialog product={product} setOpenDialog={setOpenDialog} />}
		</>
	);
};
